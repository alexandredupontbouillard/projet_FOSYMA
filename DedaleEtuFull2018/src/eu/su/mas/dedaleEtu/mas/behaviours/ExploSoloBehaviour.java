...
public class ExploSoloBehaviour extends SimpleBehaviour {
	...
	public void action() {
		...
		if (myPosition!=null){
			...
			Couple<List<Couple<String,List<Couple<Observation,Integer>>>>,String> content = new Couple(lobs,myPosition);
			try {
		...
		if(interblocage){
			...
			msg.setSender(this.myAgent.getAID());
			try {
				Couple<List<String>,Set<String>> c = new Couple(openNodes,closedNodes);
